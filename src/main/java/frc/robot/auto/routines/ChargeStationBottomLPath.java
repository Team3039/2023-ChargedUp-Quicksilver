...
public class ChargeStationBottomLPath extends SequentialCommandGroup {

  public ChargeStationBottomLPath(Drive swerve) {
  SwerveAutoBuilder autoBuilder = PPTrajectoryGenerator.getAutoBuilder();

  Command bottomLPath = autoBuilder.fullAuto(PPTrajectoryGenerator.getChargeStationBottomLPath()); 
