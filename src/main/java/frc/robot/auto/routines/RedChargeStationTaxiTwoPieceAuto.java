...
public class RedChargeStationTaxiTwoPieceAuto extends SequentialCommandGroup {
  ...
  public RedChargeStationTaxiTwoPieceAuto(Drive swerve) {
    addCommands(
        ...
        new ParallelDeadlineGroup(
          new DriveToPose(swerve, new Pose2d(14.65, 2.7, new Rotation2d(0)), false),
